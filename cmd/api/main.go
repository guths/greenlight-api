...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "3289e1480d19dc", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "40f2c3aaf6b9c2", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.guths.net>", "SMTP sender")
